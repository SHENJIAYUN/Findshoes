...
/**
 	* A data access object (DAO) providing persistence and search support for OnlineStore entities.
...
public class OnlineStoreDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(OnlineStoreDAO.class);
		//property constants
    ...
    public OnlineStore findById( java.lang.String id) {
        ...
        try {
            OnlineStore instance = (OnlineStore) getSession()
                    .get("com.model.OnlineStore", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(OnlineStore instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.model.OnlineStore")
	...
	public List findByLikes(Object likes
	) {
		return findByProperty(LIKES, likes
		);
	}
    ...
    public OnlineStore merge(OnlineStore detachedInstance) {
        ...
        try {
            OnlineStore result = (OnlineStore) getSession()
