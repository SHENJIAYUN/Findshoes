    ...
    <div class="mainer">
         <div class="admin-navbar">
            ...
            <ul class="nav nav-inline admin-nav">
                ...
                <li><a href="store-err" class="icon-user"> 商店</a></li>
		...
		<div style="position:relative;padding-top:2em">
             <table class="table table-hover" style="position:relative;table-layout:fixed;padding-top:1.5em">
                        ...
                        <tr style="width:995px;height:100px;boder:none">
                            <th style="font-size:.9em" colspan="14"><h2 style="padding-left:20em;padding-bottom:45px;font-weight:300">对不起，此页功能尚未开放。</h2></th>
                        </tr>
                         <tr style="width:995px;">
                            <th colspan="14"><a href="index.jsp" target="#" style="padding-left:45em;font-size:.9em;color:#FF6600;font-weight:200">
                            	返回</a></th>
                        </tr>
