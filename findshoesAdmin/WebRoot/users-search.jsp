         ...
         <div class="admin-navbar">
            ...
            <ul class="nav nav-inline admin-nav">
                ...
                <li class="active"><a href="shoes-search.jsp" class="icon-cog"> 鞋子</a>
            		<ul><li><a href="users-search.jsp">用户搜索</a></li><li  class="active"><a href="users-add.jsp">添加</a></li><li><a href="users-batchadd.jsp">批量添加</a></li></ul>
                </li>
