			...
			<div class="mainer">
				<div class="admin-navbar">
					<span class="float-right"> <a
						...
						class="button button-little bg-yellow" href="login.jsp">注销登录</a> </span>
					<ul class="nav nav-inline admin-nav">
						<li>
							<a href="index.jsp" class="icon-home"> 开始</a>
							<li>
								<a href="system.jsp" class="icon-home"> 系统</a>
								<!-- <li>
									<a href="home.jsp" class="icon-file-text"> 首页</a> -->
									<li >
										<a href="shoes-search.jsp" class="icon-cog"> 鞋子</a>
										<ul>
											<li class="active">
												<a href="users-search.jsp">用户搜索</a>
											</li>
											<li >
												<a href="users-add.jsp">添加</a>
											</li>
											<li>
												<a href="users-batchadd.jsp">批量添加</a>
											</li>
										</ul>
									</li>
<!-- 									<li>
										<a href="classify.jsp" class="icon-file-text"> 分类条件</a>
									</li> -->
									<li>
										<a href="article.jsp" class="icon-file-text"> 文章</a>
									</li>
									<li>
										<a href="#" class="icon-user"> 商店</a>
									</li>
									<li class="active">
										<a href="users-search.jsp" class="icon-file">用户</a>
									</li>
					</ul>
				</div>
