...
<div class="admin">
    ...
    <div class="panel admin-panel">
        ...
        <div style="font-size:1em;color:#F30;font-family:microsoft YaHei;margin-left:30em;"><span>添加成功</span></div>
        <div class="formtitle"><span>添加鞋子信息</span></div>
        <table class="table table-hover" style="table-layout:fixed">
        	<tr><th width="45">选择</th><th width="50">文章ID</th><th width="30">类型</th><th width="*">名称</th><th width="*">内容</th><th width="100">时间</th><th width="100">操作</th></tr>
            <tr><td><input type="checkbox" name="id" value="1" /></td><td><s:property value ="article.artical_id" /></td><td><s:property value ="article.type" /></td><td><s:property value ="article.title" />                                 
 				 </td><td><s:property value ="article.content" /></td><td>2015-2-6</td><td><a class="button border-blue button-little" href="#">修改</a> <a class="button border-yellow button-little" href="#" >删除</a></td></tr>

        </table>
<%--         <div class="panel-foot text-center">
            <s:iterator value="imageFileName" status="length">
 			 <div>                                                                                                
 				<img id="upload-img" style="display:inline;padding:3px; border: solid 1px #ccc; text-align: center;width:200px;height:100px" src="E:/Program Files/apache-tomcat-7.0.37/webapps/findshoesBackend/uploadImages/<s:property value ="imageFileName" /> " />                                  
 				<br />                                                                                             
