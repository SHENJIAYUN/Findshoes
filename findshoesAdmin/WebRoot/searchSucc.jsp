...
<body >
		...
		<div style="position:relative;padding-top:2em;width:100%">
             <table class="table table-hover" style="position:relative;padding-top:1.5em;table-layout:fixed;overflow:hidden;width:100%">
                        ...
                        <s:iterator value="#session.showShoesList" status="var">
	                        <tr style="text-overflow: ellipsis;white-space: nowrap;overflow:scroll;font-size:.8em">
	                            <td width=20 style="overflow:hidden;"><input type="checkbox" name="id" value=<s:property value="shoes.goodsId" /> class ="deleck"/></td>  <td width=20>1</td>  <td><s:property value="shoes.goodsId" /></td> 
	                            ...
	                            <!-- <td style="overflow:hidden;"><s:property value="shoes.occasion" /></td> --> <td style = "overflow:hidden"><s:property value="shoes.color" /></td>  <td>2014/10/23</td><td><s:property value="shoes.flag" /></td>
	                            <td style="overflow:hidden;"><a class="button border-blue button-little" href="#">修改</a>
	                                <input type="button" class="button border-yellow button-little" onclick="deleSelect()" value="删除">
	                            </td>
	                        </tr>
                        </s:iterator> 
                    </table>
...
-->           
				 <div class = "ckButton"> 
					...
					<input style="float:right;width:4em;height:1.6em;background:#F60;color:#FFF;font-size:1em;border:none;border-radius:5px;" type="button" value="删除" onclick="deleSelect()"/>
				 </div> 
				 ...
				 <div class = "select-group">
					...
					<input style="float:right;width:4em;height:1.6em;background:#F60;color:#FFF;font-size:1em;border:none;border-radius:5px;" type="button" value="确定" onclick="seleChg()"/>
				 </div>
				</div>
				...
				<div class="page-group">
		           ...
		           <!--  <ul class="pagination"></ul> -->
		            ...
		            <div style="position:relative;padding-top:.8em">
		                <form name="formpage" >
		                    第<input name='SkipPage' onKeyDown='if(event.keyCode==13)event.returnValue=false' onchange="if(/\D/.test(this.value)){alert('请输入需要跳转到的									                页数并且必须为整数！');this.value='1';}"style='width: 20px;text-align:center' type='text' value='1'>页
	...
	function seleChg(){
		...
		$.ajax({
				...
				success:function(string){
					/* alert("ajax success");  */
					var jsonArr = string;  
				    /* window.self.location = "shoes-search.jsp";  */
				    location.reload();
				},
